# Project Fishing Roguelike

## **Résumé en une phrase du jeu** 
Jeu de pêche en VR avec des éléments de roguelike.

## **Description écrite**
Pour notre projet final, nous sommes partis de l'idée de créer un jeu de pêche, mais comme je trouvais l'idée trop simple, j'ai décidé que ce serait intéressant si notre jeu aurait des éléments de roguelikes afin d'en faire une expérience rejouable.
### Gameplay loop
...
Pour l'action de pêcher en elle-même, je ne suis pas encore certain de ce que nous allons faire, mais mon idée en ce moment serait d'avoir un jeu de rythme à un bouton, lorsque l'on appui au bon moment, le poisson se rapproche, sinon il s'éloigne. Le jeu devienderai plus compliqué plus le poisson est rare.
